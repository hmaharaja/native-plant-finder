...
description: Create distinctive, production-grade frontend interfaces with high design quality. Use when building or refining the web components for this app (HTML/CSS/JS/React) with bold aesthetics, purposeful layouts, motion, and accessibility. Avoid generic AI-looking output.
---
...
Build memorable, functional interfaces with a clear aesthetic direction (no generic templates). Focus on smooth typography, cohesive palettes, purposeful lines of motion, semantic structure, and accessibility. This is a plant related app, so the aesthetics should feel smooth, light, and natural.
...
- If anything is unclear, don't guess - stop and ask the user.
